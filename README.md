# <p align="center">  ______________________ Python ________________________  </p>  
...
c = 2.5
d = bytes(2)
e = [10, 20, "ALex", [32, 53, True]]
f = ((13), ('Vadim'), (1.5))
j = {"Hello", "Mike"}
h = frozenset(j)
i = {"Alex": 32, "Svetlana": 34}
...
# Print two variables (type: string and integer) using comma
pp = "Samsung SSD"
jj = 980
print("SSD :", pp, jj)

# Print different variables (type: string and integer) using plus
vv = "Corsair HX"
cc = 1200
print("Power supply : " + vv + str(cc))
```
...
if item_1 % 2 != 0:
    print("result =", item_1, "- variable is -odd")
else:
    print("result = ", item_1, "- variable is -even")

# 20. Присвоить переменной item_2 even значение
if item_2 % 2 != 0:
    print("result =", item_2, "- variable is -odd")
else:
    print("result =", item_2, "- variable is -even")
...
print("result_m_floor (using math) =", result_m_floor)
